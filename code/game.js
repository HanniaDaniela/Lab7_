...
function Enemy(pos) {
  ...
  this.kill = Math.random() * Math.PI * 2;
}
...
var killSpeed = 1, killDist = 1;

Enemy.prototype.act = function(step) {
  this.kill += step * killSpeed;
  var killPos = Math.sin(this.kill) * killDist;
  this.pos = this.basePos.plus(new Vector(0, killPos));
};
...
var wobbleSpeed = 1.5, wobbleDist = 1.5;
